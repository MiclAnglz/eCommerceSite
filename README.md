...
- This site was ran on a local server using XAMMP control panel. Please download and follow instructions for installation from https://www.phpmyadmin.net/ and use the database save in the "SQLite_DB" folder.
